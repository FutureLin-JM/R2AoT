Ponder.registry((e) => {
    ...
    e.create(['embers:fluid_pipe', 'embers:fluid_extractor', 'embers:fluid_transfer']).scene('fluid_pipes_two', "Filtering Outputs", (scene) => {
        ...
        scene.showControls(35, [0, 2, 2], "left").rightClick().withItem('embers:molten_lead_bucket')
        ...
        scene.world.modifyBlockEntityNBT([0, 2, 2], (nbt) => {
            nbt.filter = { FluidName: "embers:molten_lead", Amount: 1000}
        });
        scene.idle(40);
        ...
        scene.showControls(35, [4, 2, 2], "down").withItem('embers:molten_lead_bucket')

        scene.idle(40);

        scene.world.modifyBlockEntityNBT([0, 3, 2], (nbt) => {
            nbt.FluidName = "embers:molten_lead"
            nbt.Amount = 16000
        });
