Ponder.registry((e) => {
    e.create('embers:pressure_refinery').scene('pressure_refinery_scene_one', "Generating Tier 2 Ember Power", (scene, util) => {
        ...
        scene.text(100, "And at maximum, x3. See JEI for the list of multiplier blocks.")
        
        scene.idle(40);

        scene.showControls(35, [2, 2, 2], "down").rightClick().withItem('embers:silver_block')
        ...
        scene.world.setBlocks([2, 1, 2], "embers:silver_block", false);
        scene.world.showSection([2, 1, 2], Facing.EAST);
