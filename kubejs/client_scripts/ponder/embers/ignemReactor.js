Ponder.registry((e) => {
    e.create(['embers:ignem_reactor', 'embers:catalysis_chamber', 'embers:combustion_chamber']).scene('ignem_reactor_scene_one', "Generating Tier 3 Ember Power", (scene, util) => {
        ...
        scene.text(80, "And at maximum, x4. See JEI for the list of chamber inputs.")
        
        scene.idle(40);

        scene.showControls(60, [4, 1, 2], "right").withItem('minecraft:glowstone_dust')
        scene.showControls(60, [1, 1, 2], "left").withItem('minecraft:blaze_powder')
