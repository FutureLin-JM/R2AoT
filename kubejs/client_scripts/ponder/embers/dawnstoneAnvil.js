Ponder.registry((e) => {
    e.create(['embers:dawnstone_anvil', 'embers:isolated_materia', 'embers:ancient_motive_core']).scene('dawnstone_anvil_scene_one', "Dawnstone Anvil Basics", (scene, util) => {
        ...
        scene.showControls(35, [2, 2, 2], "down").rightClick().withItem('minecraft:diamond_pickaxe')
        
        scene.idle(40);

        scene.world.modifyBlockEntityNBT([2, 1, 2], (nbt) => {
            nbt.inventory.Items = [{ Slot: 0, id: "minecraft:diamond_pickaxe", Count: 1 }]
        });
        ...
        scene.world.modifyBlockEntityNBT([2, 1, 2], (nbt) => {
            nbt.inventory.Items = [{ Slot: 0, id: "minecraft:diamond_pickaxe", Count: 1 }, { Slot: 1, id: "embers:isolated_materia", Count: 1 }]
        });
        ...
        scene.idle(40);
        const pickaxe = scene.world.createItemEntity(centerTop, util.vector.of(0.1, 0.1, -0.1), "minecraft:diamond_pickaxe")
        scene.world.modifyBlockEntityNBT([2, 1, 2], (nbt) => {
            nbt.inventory.Items = [{ Slot: 0, id: "", Count: 0 }]
        });
