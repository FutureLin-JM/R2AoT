...
ServerEvents.recipes(event => {
    // pressing 动力冲压机 压片
    const { mixing, splashing, milling, deploying, compacting, pressing, filling } = event.recipes.create;
    ...
    materials.forEach(material => {
        create
            ...
            .withCatalyst(`r2aot:compressed_${material}`)
            .requiredBonks(3)
    ...
    create
        .createMechanicalExtruderExtruding('minecraft:obsidian', Array(2).fill(Fluid.of('r2aot:petal_essence', 1000)))
