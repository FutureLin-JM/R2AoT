ServerEvents.recipes(event => {
    ...
    // 彩虹花源块
    kubejs.shapeless('r2aot:rainbow_petal_block', [
    ...
    // 圆石
    kubejs.shaped('minecraft:cobblestone', [
        'GG ',
        'GG ',
        '   '
    ...
    // 安山岩
    kubejs.shaped('4x minecraft:andesite', [
        'CCC',
        'CGC',
        'CCC'
    ], {
    ...
    // 激光钻
    kubejs.shaped('2x industrialforegoing:laser_drill',[
        'pfp',
        'bmb',
        'grg'
    ],{
    ...
    // 树苗
    kubejs.shaped('minecraft:oak_sapling', [
        'GGG',
		' G ',
		' G '
    ], {
    ...
    // 木剪刀
    kubejs.shaped('r2aot:wooden_shears', [
        ' O ',
		'  O',
		'B  '
    ], {
    ...
    // 锤子
    kubejs.shaped('r2aot:wooden_hammer', [
        ' A ',
        ' BA',
        'B  '
    ], {
    ...
    kubejs.shaped('r2aot:stone_hammer', [
        '  A',
        ' B ',
        'C  '
    ], {
    ...
    // 压缩锤子
    kubejs.shaped('r2aot:compressed_wooden_hammer', [
        ' AA',
        ' AA',
        'B  '
    ], {
    ...
    kubejs.shaped('r2aot:compressed_stone_hammer', [
        ' AA',
        ' AA',
        'B  '
    ], {
    ...
    kubejs.shaped('4x minecraft:chest', [
        ...
        'A A',
        'AAA'
    ], {A:'#minecraft:logs'}).id(kjs('chest_from_logs'))

    // 魔力池
    kubejs.shaped('botania:mana_pool', [
        '   ',
        'ABA',
        'AAA'
    ], {
    ...
    // 熔炉组件Level1
    kubejs.shaped('r2aot:iron_furnace_component', [
        'AAA',
        'ABA',
        'ACA'
    ], {
    ...
    kubejs.shaped('r2aot:copper_furnace_component', [
        'AAA',
        'ABA',
        'ACA'
    ], {
    ...
    kubejs.shaped('r2aot:gold_furnace_component', [
        'AAA',
        'ABA',
        'ACA'
    ], {
    ...
    kubejs.shapeless('r2aot:data_model_base', [
        'hostilenetworks:blank_data_model'
    ]).id(kjs('hostilenetworks_data_model_base'));

    // 初级种子
    kubejs.shaped('r2aot:prudentium_crop_seed', [
        'AAA',
        'ABA',
        'AAA'
    ], {
    ...
    // 热力组件
    kubejs.shaped('thermal:upgrade_augment_1', [
        'IGI',
        'RXR',
        'IGI'
    ],{
    ...
    // 创造魔力池
    kubejs.shaped('botania:creative_pool', [
        'ABA',
        'ACA',
        'AAA'
    ], {
    ...
    // 神秘方块
    kubejs.shaped('ae2:mysterious_cube', [
        'ABA',
        'BCB',
        'ABA'
