ServerEvents.recipes(event => {
    ...
    dissolution_chamber(
        '8x mysticalagriculture:inferium_essence',
    ...
    dissolution_chamber(
        Item.of(
            'kubejs:incomplete_water_seeds',
            '{SequencedAssembly:{Progress:0.2f,Step:1,id:"kubejs:sequenced_assembly/water_seeds"}}'
        ),
    ...
    dissolution_chamber(
        Item.of(
            'kubejs:incomplete_fire_seeds',
            '{SequencedAssembly:{Progress:0.2f,Step:1,id:"kubejs:sequenced_assembly/fire_seeds"}}'
        ),
    ...
    dissolution_chamber(
        Item.of(
            'kubejs:incomplete_earth_seeds',
            '{SequencedAssembly:{Progress:0.2f,Step:1,id:"kubejs:sequenced_assembly/earth_seeds"}}'
        ),
    ...
    dissolution_chamber(
        Item.of(
            'kubejs:incomplete_air_seeds',
            '{SequencedAssembly:{Progress:0.2f,Step:1,id:"kubejs:sequenced_assembly/air_seeds"}}'
        ),
